  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-semibold transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:bg-neutral-100 disabled:from-neutral-100 disabled-to-neutral-100 disbaled:text-neutral-300 border border-neutral-200 shadow-sm",
  {
    variants: {
      variant: {
        ...
        destructive:
          "bg-gradient-to-b from-amber-600 to-orange-700 text-destructive-foreground hover:from-amber-700 hover:to-amber-700 ",
        outline:
